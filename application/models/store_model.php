...
class Store_model extends CI_Model
{
	...
	public function create_store($version,$product_url,$store_name,$db_details,$shopkeeper_token,							 $shopous_token,$analytics_site,$email_address,$password){
		...
		if(!$this->populate_user_db($analytics_site,$db_details,$email_address,$password,$shopous_token,$shopkeeper_token,$store_name)){
